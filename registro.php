    ...
    $("#ap").hide()  
     $("#cliente").autocomplete("autocomplete.php", {
        selectFirst: true
          ...
          $("#buscfac").autocomplete("autocomplete_ap.php", {
        selectFirst: true
      });
    });
        </script>
...
<option value="-">- 
  <?php }?>
    ...
    <select name="forma2" id="forma2" style="text-transform:uppercase" onkeypress="return pulsar(event)" onchange="cambia_forma2()">
    <option value="#">SELECCIONE</option>
    ...
    <P id='ap'>Aplicacion a factura:<input type="text" name="buscfac" id='buscfac'></P>
...
function cambia_forma2(){ 
    //tomo el valor del select del pais elegido 
    var fp 
    fp = document.registro.forma2[document.registro.forma2.selectedIndex].value 
    //miro a ver si el pais está definido 
    if (fp == 'TRASPASO DE FACTURA/ANTICIPO') { 
          $("#ap").show()
         }  
    else{
          $("#ap").hide()      
