...
<title>Cobranza(Facturas)</title>
<link rel="stylesheet" href="bootstrap-3.2.0-dist/css/bootstrap.min.css">

<style type="text/css">
	table{width:81%;box-shadow:0 0 10px #ddd;text-align:left; background-color: #F2F2F2; position:absolute;right:50px;font-size:12px;}
...
$fecha2=$_POST['ffin'];
$query=mysql_query("SELECT id,estado,factura, cliente, importemn, importe_dls,fechafactura, fechacontrarecibo FROM facturacion WHERE tipopago='CREDITO' AND estado!='CANCELADA' AND pagada!='on' AND fechafactura >= '$fecha1' AND fechafactura <= '$fecha2' order by id desc");
...
echo '</table>';
?> 
<button onclick="location.href='todasfac.php'" class="boton_1" id="boton_1">Modificar Facturas</button>
</div>
</body>
</html>