...
$sqld=mysql_query("select importemn, importedls from remision where fecharem='$actual' AND tipopago='CONTADO'");
if ($sqld)
{
...
$sqlt=mysql_query("select importemn, importedls from remision where fecharem='$actual' AND tipopago='CREDITO'");
if ($sqlt)
{
...
$sqln=mysql_query("select importemn, importedls from remision where fecharem='$actual' AND tipopago='CONTADO' AND formapago='EFECTIVO'");
if ($sqln)
{
...
$sqlk=mysql_query("select importemn, importedls from remision where fecharem='$actual' AND tipopago='CONTADO' AND formapago='TARJETA'");
if ($sqlk)
{
...
$sqlc=mysql_query("select importemn, importedls from remision where fecharem='$actual' AND tipopago='CONTADO' AND formapago='CHEQUE'");
if ($sqlc)
{
...
$sqlg=mysql_query("select importemn, importedls from remision where fecharem='$actual' AND tipopago='CONTADO' AND formapago='TRANSFERENCIA'");
if ($sqlg)
{
...
$sqlx=mysql_query("select importemn, importedls from remision where fecharem='$actual' AND tipopago='CONTADO' AND formapago='TRASPSALDO'");
if ($sqlx)
{
...
/**********************************TOTALES CONTADO CHEQUE remisiones ********/
/**********************************TOTALES CONTADO  EFECTIVO remisiones ********/
$sqlcr1=mysql_query("select importemn, importedls from remision where fecharem='$actual' AND tipopago='CREDITO' AND formapago='EFECTIVO'");
if ($sqlcr1)
{
...
/***********************TOTALES DE REMISIONES  EFECTIVO FIN*/
/**********************************TOTALES CONTADO TARJETA remisiones ********/
$sqlcr2=mysql_query("select importemn, importedls from remision where fecharem='$actual' AND tipopago='CREDITO' AND formapago='TARJETA'");
if ($sqlcr2)
{
...
$sqlcr3=mysql_query("select importemn, importedls from remision where fecharem='$actual' AND tipopago='CREDITO' AND formapago='CHEQUE'");
if ($sqlcr3)
{
...
/**********************************TOTALES CONTADO TRANSFERENCIA remisiones ********/
$sqlcr4=mysql_query("select importemn, importedls from remision where fecharem='$actual' AND tipopago='CREDITO' AND formapago='TRANSFERENCIA'");
if ($sqlcr4)
{
...
/**********************************TOTALES CONTADO T SALDO remisiones ********/
$sqlcr5=mysql_query("select importemn, importedls from remision where fecharem='$actual' AND tipopago='CREDITO' AND formapago='TRASPSALDO'");
if ($sqlcr5)
{
...
$quenot=mysql_query("select nota, cliente, importemn, importedls, factura, descri, estado  from notacredito  where fechanota='$actual'");
if($quenot)
{
...
$pdf->ezText("------------------------------------------------------------------------------------------------------------------------------------------------",10);
$pdf->ezText("Total MN $".$smnf3."           Total DLS $".$dlsf6."",9);
}
$pdf->ezText("");
