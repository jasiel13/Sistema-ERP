...
//facturas
$queEmp = ( "select factura, cliente, importemn, importedls, tipopago, formapago, estado from serviciosfac where fechafactura='$actual'");
...
/********************************TOTALES DE FACTURAS****************************/
$q=mysql_query ("select importemn, importedls from serviciosfac where fechafactura='$actual' AND tipopago='CONTADO' AND formapago='EFECTIVO'");
if($q)
{
	$c=mysql_num_rows($q);
...
/*****************************************CHEQUE*******************************/
$q1=mysql_query ("select importemn, importedls from serviciosfac where fechafactura='$actual' AND tipopago='CONTADO' AND formapago='CHEQUE'");
if($q1)
{
...
/**************************************TERJETA*****************************/
$q2=mysql_query ("select importemn, importedls from serviciosfac where fechafactura='$actual' AND tipopago='CONTADO' AND formapago='TARJETA'");
if($q2)
{
...
/*************************************TRANSFERENCIA***************************/
$q3=mysql_query ("select importemn, importedls from serviciosfac where fechafactura='$actual' AND tipopago='CONTADO' AND formapago='TRANSFERENCIA'");
if($q3)
{
...
/************************************CREDITO***********************************/
$q4=mysql_query ("select importemn, importedls from serviciosfac where fechafactura='$actual' AND tipopago='CREDITO'");
if($q4)
{
...
/*************************************************************COBRANZA****************////
$queEmp1 = ( "select facped, cliente, importemn, importedls, formapago, observaciones from servicioscob where fechacobro='$actual'");
...
/********************************TOTALES DE COBRANZA****************************/
//total total
$Q0=mysql_query ("select importemn, importedls from servicioscob where fechacobro='$actual'");
if($Q0)
{
...
/*******************************EFECTIVO***********************************/
$Q=mysql_query ("select importemn, importedls from servicioscob where fechacobro='$actual' AND formapago='EFECTIVO'");
if($Q)
{
...
/***********************************TARJETA**********************************/				
$Q1=mysql_query ("select importemn, importedls from servicioscob where fechacobro='$actual' AND formapago='TARJETA'");
if($Q1)
{
...
/***********************************CHEQUE*******************************/
$Q2=mysql_query ("select importemn, importedls from servicioscob where fechacobro='$actual' AND formapago='CHEQUE'");
if($Q2)
{
...
/************************************TRANSDERENCIA*******************/
$Q3=mysql_query ("select importemn, importedls from servicioscob where fechacobro='$actual' AND formapago='TRANSFERENCIA'");
if($Q3)
{
...
/**************************************/
//notas de credito*
$queEmp3="select nc, cliente, importemn, importedls, factura, descr, estado  from ncsea  where fecha='$actual'";
...
/**********************************FIN TOTALES GENERALES*************************/			
				...
				'width'=>580,
				'fontsize'=>6);			
	$txttit = "<b>SERVICIOS ECOAMBIENTALES S.A DE C.V</b>\n<b>CORTE DEL DIA $actual</b>";
