  ...
  if (document.factura.value =="" )
    {
        ...
        alert("Ingrese folio de la factura.");
...
Tipo de pago
   ...
   <option  value="<?php if($contador>0){echo $array[8];}else{ echo "#";}?>" onKeyUp="this.value=this.value.toUpperCase();">SELECCIONE</option>
