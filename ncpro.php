...
<body>
	...
	<?php
		...
		$q=mysql_query("insert into ncsea (nc, fecha, cliente, importemn, importedls, factura, descr,usuario) values ('$nc','$fecha', '$cliente', '$importemn', '$importedls', '$factura', 'desc', '$usuario')");
